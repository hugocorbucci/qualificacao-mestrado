...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Open Source and Agile:\\
...
dificuldades. Apesar dos diversos professionais envolvidos em ambos
...
\begin{tabular}{ll}
 		...
 		FLOSS       & Software \Large{Gratuito?} Livre e de código aberto (\emph{Free, Libre and Open Source Software}).\\
\end{tabular}
...
\appendix
\include{ape-pesquisas}      % associado ao arquivo: 'ape-pesquisas.tex'
